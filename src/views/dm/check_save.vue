<template>
    <div>
        ...
        <div class="advice-result" v-if="advice_text!=false">
        ...
        <div class="advice-result" v-if="advice_goals!=false">
            ...
            <table class="gridtable">
                <thead>
                <tr>
                    <th v-for="item in theadgoal">{{item.name}}</th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="item in advice_goals">
                    <td>{{item.name}}</td>
                    <td>{{item.desc}}</td>
            ...
            getData:function () {
                ...
                $.ajax({
                    ...
                    "success":function (data) {
                        ...
                        me.advice_goals = data["advice_goals"];
                    },
                    "error":function (data) {
                        Toast({
                            message: '提交失败',
